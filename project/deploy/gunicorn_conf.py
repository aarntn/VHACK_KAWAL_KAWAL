...
# Load model artifacts once in the master process — shared across workers, avoids N pkl copies
preload_app = True

# Recycle workers periodically to prevent memory creep; jitter prevents thundering-herd restarts
