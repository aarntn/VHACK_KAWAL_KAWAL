...
def evaluate_candidate(
    ...
    final_scores = clamp01(base_scores + context_adj)
...
def main() -> None:
        ...
        rows.append(
            {
                ...
                "policy_pass": (result.fpr <= args.target_fpr) and (result.precision >= args.target_precision),
            }
        )
    ...
    best_scores = clamp01(base_scores + best_context_adj)
    ...
    selected_scores = clamp01(base_scores + selected_context_adj)
    ...
    output = {
        ...
        "policy_checks": {
            ...
            "overall_pass": fpr_pass and precision_pass,
