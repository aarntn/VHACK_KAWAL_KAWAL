...
export interface FraudResultScreenProps {
  ...
  reasons?: string[];
  embedded?: boolean;
  runtimeMode?: "primary" | "cached_context" | "degraded_local";
  onGoBack?: () => void;
  onCheckAnother?: () => void;
...
function runtimeModeLabel(
  ...
  const key = `result.runtimeMode.${runtimeMode}` as const;
  ...
  return (
    <div
      style={{
        ...
        borderRadius: embedded ? 28 : undefined,
      }}
    >
      {/* Scrollable body */}
      <div style={{ flex: 1, padding: "32px 16px 140px 16px", overflowY: "auto" }}>
        ...
        >
          ...
          >
            ...
            />
            <SummaryRow
              label={translate("result.runtimeMode.label")}
              value={runtimeModeLabel(runtimeMode, translate)}
              last
            />
          </div>
